...
export const FOODS: Food[] = [
  ...
  { id: "carne-alcatra", name: "Alcatra grelhada", category: "Carnes", kcalPer100g: 196, carbPer100gG: 0, proteinPer100gG: 32.6, fatPer100gG: 6.6, units: [{ label: "filé", grams: 120 }] },
  { id: "carne-picanha", name: "Picanha grelhada", category: "Carnes", kcalPer100g: 289, carbPer100gG: 0, proteinPer100gG: 26.9, fatPer100gG: 19.6, units: [{ label: "fatia", grams: 100 }] },
  { id: "carne-costela", name: "Costela bovina assada", category: "Carnes", kcalPer100g: 270, carbPer100gG: 0, proteinPer100gG: 24.5, fatPer100gG: 18.7, units: [{ label: "pedaço", grams: 100 }] },
  { id: "carne-seca", name: "Carne seca cozida", category: "Carnes", kcalPer100g: 250, carbPer100gG: 0, proteinPer100gG: 36, fatPer100gG: 11, units: [{ label: "porção", grams: 80 }] },
  { id: "bacon", name: "Bacon frito", category: "Carnes", kcalPer100g: 541, carbPer100gG: 1.4, proteinPer100gG: 37, fatPer100gG: 42, units: [{ label: "fatia", grams: 8 }] },
  { id: "linguica", name: "Linguiça toscana grelhada", category: "Carnes", kcalPer100g: 297, carbPer100gG: 1.5, proteinPer100gG: 15, fatPer100gG: 26, units: [{ label: "unidade", grams: 80 }] },
  { id: "presunto", name: "Presunto cozido", category: "Carnes", kcalPer100g: 106, carbPer100gG: 1.8, proteinPer100gG: 17.3, fatPer100gG: 3.2, units: [{ label: "fatia", grams: 15 }] },
  { id: "carne-porco-lombo", name: "Lombo de porco assado", category: "Carnes", kcalPer100g: 210, carbPer100gG: 0, proteinPer100gG: 28.7, fatPer100gG: 10.1, units: [{ label: "fatia", grams: 100 }] },
